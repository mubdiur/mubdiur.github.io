...
function renderTools() {
  ...
  function renderResults() {
    ...
    results.appendChild(App.el('div', { class: 'text-xs font-mono', style: { color: 'rgba(166,173,200,0.7)', marginBottom: '0.75rem' },
  ...
  var root = App.el('div', { class: 'w-full' },
    App.el('div', { class: 'tools-hero' },
      App.el('div', { class: 'tools-hero-inner' },
        App.el('div', { class: 'flex items-center gap-3 mb-3' },
          ...
          App.el('span', { class: 'text-xs font-mono', style: { color: 'rgba(166,173,200,0.7)' }, text: TOOLMANIFEST.length + ' Tools · all client-side, zero server' })),
    ...
    App.el('div', { class: 'tools-content' },
      App.el('div', { class: 'search-row' },
        ...
        App.el('div', { class: 'flex items-center gap-1.5 text-xs font-mono', style: { color: 'rgba(166,173,200,0.6)' } },
          App.icon('command', '', 14),
          App.el('kbd', { text: 'K' }))),
      catTabs,
      results));
