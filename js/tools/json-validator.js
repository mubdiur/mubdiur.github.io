...
App.registerTool('json-validator', {
  css: '' +
    '.t-json-validator .seg{display:flex;border:1px solid rgba(30,32,41,0.4);border-radius:6px;overflow:hidden;}\n' +
    '.t-json-validator .seg button{padding:0.25rem 0.625rem;font-family:var(--font-mono);font-size:10px;background:rgba(0,0,0,0.2);color:rgba(170,170,179,0.6);border:none;cursor:pointer;border-right:1px solid rgba(30,32,41,0.4);transition:all .15s;}\n' +
    '.t-json-validator .seg button:last-child{border-right:none;}\n' +
    '.t-json-validator .seg button:hover{color:rgba(233,233,236,0.9);}\n' +
    '.t-json-validator .seg button.active{background:rgba(194,220,212,0.15);color:var(--cyan-glow);}\n' +
