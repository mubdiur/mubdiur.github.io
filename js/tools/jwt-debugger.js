...
App.registerTool('jwt-debugger', {
  css: '' +
    ...
    '.t-jwt-debugger .lbl-header{color:rgba(194,220,212,0.7);}\n' +
    '.t-jwt-debugger .lbl-payload{color:rgba(194,220,212,0.7);}\n' +
    '.t-jwt-debugger .lbl-signature{color:rgba(251,146,60,0.7);}\n' +
    '.t-jwt-debugger .jwt-pre{border:1px solid rgba(30,32,41,0.4);background:rgba(0,0,0,0.3);padding:0.5rem;font-family:var(--font-mono);font-size:10px;color:rgba(233,233,236,0.8);border-radius:6px;overflow:auto;white-space:pre-wrap;word-break:break-all;}\n' +
    '.t-jwt-debugger .jwt-hdr{max-height:128px;}\n' +
    '.t-jwt-debugger .jwt-pay{max-height:192px;}\n' +
    '.t-jwt-debugger .jwt-sig{color:rgba(233,233,236,0.6);}\n',
