...
App.registerTool('jwt-debugger', {
  css: '' +
    ...
    '.t-jwt-debugger .lbl-header{color:rgba(163,191,160,0.7);}\n' +
    '.t-jwt-debugger .lbl-payload{color:rgba(163,191,160,0.7);}\n' +
    '.t-jwt-debugger .lbl-signature{color:rgba(251,146,60,0.7);}\n' +
    '.t-jwt-debugger .jwt-pre{border:1px solid rgba(75,64,56,0.4);background:rgba(0,0,0,0.3);padding:0.5rem;font-family:var(--font-mono);font-size:10px;color:rgba(202,170,152,0.8);border-radius:6px;overflow:auto;white-space:pre-wrap;word-break:break-all;}\n' +
    '.t-jwt-debugger .jwt-hdr{max-height:128px;}\n' +
    '.t-jwt-debugger .jwt-pay{max-height:192px;}\n' +
    '.t-jwt-debugger .jwt-sig{color:rgba(202,170,152,0.6);}\n',
