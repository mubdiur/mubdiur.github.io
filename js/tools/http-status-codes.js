...
App.registerTool('http-status-codes', {
  css: '' +
    ...
    '.t-http-status-codes .search-wrap svg{position:absolute;left:8px;top:50%;transform:translateY(-50%);color:rgba(170,170,179,0.5);pointer-events:none;}\n' +
    '.t-http-status-codes .search{width:100%;height:32px;padding:0 8px 0 28px;border:1px solid rgba(30,32,41,0.4);background:rgba(0,0,0,0.3);color:rgba(233,233,236,0.8);font-family:var(--font-mono);font-size:12px;border-radius:6px;outline:none;transition:border-color .2s,box-shadow .2s;}\n' +
    '.t-http-status-codes .search:focus{border-color:rgba(194,220,212,0.4);box-shadow:0 0 0 1px rgba(194,220,212,0.3);}\n' +
    '.t-http-status-codes .search::placeholder{color:rgba(170,170,179,0.3);}\n' +
    ...
    '.t-http-status-codes .row{display:flex;align-items:flex-start;gap:0.75rem;padding:0.5rem;border-radius:8px;border:1px solid rgba(30,32,41,0.2);background:rgba(0,0,0,0.1);cursor:pointer;transition:background-color .2s;}\n' +
    ...
    '.t-http-status-codes .c-1{color:rgba(194,220,212,0.8);}\n' +
    '.t-http-status-codes .c-2{color:rgba(194,220,212,0.8);}\n' +
    ...
    '.t-http-status-codes .lbl{font-size:10px;font-family:var(--font-mono);color:rgba(170,170,179,0.4);}\n' +
    '.t-http-status-codes .name{font-size:12px;font-weight:500;font-family:var(--font-mono);color:rgba(233,233,236,0.8);}\n' +
    '.t-http-status-codes .desc{font-size:10px;font-family:var(--font-mono);color:rgba(170,170,179,0.6);margin-top:2px;}\n' +
    '.t-http-status-codes .none{text-align:center;padding:1rem 0;font-family:var(--font-mono);font-size:12px;color:rgba(170,170,179,0.5);}\n',
