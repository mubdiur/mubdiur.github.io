...
App.registerTool('color-converter', {
  css: '' +
    ...
    '.t-color-converter .cc-field{background:transparent;border:none;border-bottom:1px solid rgba(49,50,68,0.3);color:rgba(205,214,244,0.8);padding:0 0.25rem;outline:none;font-family:var(--font-mono);font-size:10px;}\n' +
    '.t-color-converter .cc-field:focus{border-color:rgba(148,226,213,0.5);}\n' +
    '.t-color-converter .cc-field.cc-dim{color:rgba(205,214,244,0.6);}\n' +
