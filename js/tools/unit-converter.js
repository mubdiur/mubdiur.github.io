...
App.registerTool('unit-converter', {
  css: '' +
    ...
    '.t-unit-converter .uc-sel{height:28px;border:1px solid rgba(80,73,69,0.4);background:rgba(0,0,0,0.3);font-family:var(--font-mono);font-size:12px;color:rgba(235,219,178,0.8);outline:none;}\n' +
    '.t-unit-converter .uc-sel:focus{border-color:rgba(142,192,124,0.4);box-shadow:0 0 0 1px rgba(142,192,124,0.3);}\n' +
    '.t-unit-converter .uc-sel-sm{font-size:10px;color:rgba(235,219,178,0.7);}\n' +
    '.t-unit-converter .uc-input{width:100%;height:32px;border:1px solid rgba(80,73,69,0.4);background:rgba(0,0,0,0.3);padding:0 0.5rem;font-family:var(--font-mono);font-size:12px;color:rgba(235,219,178,0.9);outline:none;}\n' +
    '.t-unit-converter .uc-input:focus{border-color:rgba(142,192,124,0.4);box-shadow:0 0 0 1px rgba(142,192,124,0.3);}\n' +
    '.t-unit-converter .uc-result{width:100%;height:32px;border:1px solid rgba(80,73,69,0.4);background:rgba(0,0,0,0.4);padding:0 0.5rem;font-family:var(--font-mono);font-size:12px;color:rgba(184,187,38,0.8);display:flex;align-items:center;white-space:nowrap;overflow:hidden;}\n' +
    '.t-unit-converter .uc-swap{margin-top:1.5rem;padding:0.25rem 0.5rem;font-family:var(--font-mono);font-size:10px;color:rgba(142,192,124,0.7);background:none;border:none;cursor:pointer;transition:color .2s,background-color .2s;}\n' +
    '.t-unit-converter .uc-swap:hover{background:rgba(142,192,124,0.1);}\n',
