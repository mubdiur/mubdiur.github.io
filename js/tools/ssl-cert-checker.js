...
App.registerTool('ssl-cert-checker', {
  css: '' +
    '.t-ssl-cert-checker .cert-input{width:100%;min-height:140px;border:1px solid rgba(30,30,34,0.4);background:rgba(0,0,0,0.3);border-radius:8px;padding:10px 12px;font-family:var(--font-mono);font-size:12px;color:rgba(232,232,234,0.9);resize:vertical;outline:none;}\n' +
    '.t-ssl-cert-checker .cert-input:focus{border-color:rgba(194,194,200,0.4);box-shadow:0 0 0 1px rgba(194,194,200,0.3);}\n' +
    '.t-ssl-cert-checker .cert-input::placeholder{color:rgba(168,168,176,0.3);}\n' +
    '.t-ssl-cert-checker .cert-status{display:flex;flex-direction:column;gap:0.75rem;border-radius:8px;border:1px solid rgba(30,30,34,0.4);padding:0.875rem;}\n' +
    '.t-ssl-cert-checker .cert-status.valid{border-color:rgba(194,194,200,0.3);background:rgba(194,194,200,0.08);}\n' +
    '.t-ssl-cert-checker .cert-status.expired{border-color:rgba(226,226,230,0.3);background:rgba(226,226,230,0.08);}\n' +
    '.t-ssl-cert-checker .cert-status.pending{border-color:rgba(204,204,210,0.3);background:rgba(204,204,210,0.08);}\n' +
    ...
    '.t-ssl-cert-checker .cert-section{border:1px solid rgba(30,30,34,0.4);border-radius:8px;overflow:hidden;}\n' +
    '.t-ssl-cert-checker .cert-section > h4{font-family:var(--font-mono);font-size:10px;text-transform:uppercase;letter-spacing:0.14em;color:rgba(168,168,176,0.8);border-bottom:1px solid rgba(30,30,34,0.4);padding:0.5rem 0.75rem;background:rgba(30,30,34,0.4);display:flex;align-items:center;justify-content:space-between;gap:0.5rem;}\n' +
    '.t-ssl-cert-checker .cert-section .body{padding:0.75rem;display:flex;flex-direction:column;gap:0.375rem;}\n' +
    '.t-ssl-cert-checker .kv{display:flex;flex-wrap:wrap;gap:0.25rem 0.75rem;font-family:var(--font-mono);font-size:12px;color:rgba(232,232,234,0.9);}\n' +
    '.t-ssl-cert-checker .kv .k{color:rgba(168,168,176,0.6);font-size:10px;min-width:7.5rem;text-transform:uppercase;letter-spacing:0.08em;padding-top:1px;}\n' +
    ...
    '.t-ssl-cert-checker .ext-table td{border-bottom:1px solid rgba(30,30,34,0.3);padding:0.375rem 0.5rem;vertical-align:top;}\n' +
    '.t-ssl-cert-checker .ext-table td:first-child{color:rgba(194,194,200,0.9);white-space:nowrap;}\n' +
    '.t-ssl-cert-checker .ext-table td:last-child{color:rgba(168,168,176,0.8);word-break:break-all;}\n' +
    ...
    '.t-ssl-cert-checker .valid .progress > div{background:rgba(194,194,200,0.8);}\n' +
    '.t-ssl-cert-checker .expired .progress > div{background:rgba(226,226,230,0.8);}\n' +
    '.t-ssl-cert-checker .pending .progress > div{background:rgba(204,204,210,0.8);}\n' +
    '.t-ssl-cert-checker .chip{display:inline-block;padding:0.125rem 0.375rem;border-radius:4px;font-family:var(--font-mono);font-size:10px;border:1px solid rgba(226,226,230,0.3);color:var(--ctp-red);}\n' +
    '.t-ssl-cert-checker .pill{display:inline-block;padding:0.125rem 0.5rem;border-radius:999px;border:1px solid rgba(194,194,200,0.25);color:rgba(194,194,200,0.9);font-family:var(--font-mono);font-size:10px;}\n' +
    ...
    '.t-ssl-cert-checker .timeblock{border:1px solid rgba(30,30,34,0.4);border-radius:6px;padding:0.5rem 0.75rem;}\n' +
    ...
    '.t-ssl-cert-checker .timeblock .big{font-family:var(--font-mono);font-size:12px;color:rgba(232,232,234,0.9);margin-top:0.25rem;}\n' +
    '.t-ssl-cert-checker .timeblock .sub{font-family:var(--font-mono);font-size:10px;color:rgba(168,168,176,0.5);margin-top:0.125rem;}\n' +
    '.t-ssl-cert-checker .note{font-family:var(--font-mono);font-size:10px;color:rgba(168,168,176,0.5);line-height:1.6;}\n',
  ...
  mount: function (root) {
    ...
    root.appendChild(App.el('div', { class: 'flex flex-col', style: { gap: '0.75rem' } },
      App.el('div', { class: 'flex items-center gap-2 flex-wrap' },
        App.el('span', { class: 'text-[10px] font-mono', style: { color: 'rgba(168,168,176,0.6)' }, text: 'PEM or DER certificate — parsed entirely in-browser (WebAssembly ASN.1 + SHA). Nothing is sent anywhere.' }),
