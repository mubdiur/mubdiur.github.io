...
App.registerTool('email-extractor', {
  css: '' +
    ...
    '.t-email-extractor .ee-input{width:100%;border-radius:8px;border:1px solid rgba(30,30,34,0.5);background:rgba(0,0,0,0.3);padding:0.5rem 0.75rem;font-family:var(--font-mono);font-size:14px;color:rgba(232,232,234,0.9);outline:none;transition:border-color .2s,box-shadow .2s;}\n' +
    '.t-email-extractor .ee-input::placeholder{color:rgba(168,168,176,0.3);}\n' +
    '.t-email-extractor .ee-input:focus{border-color:rgba(194,194,200,0.4);box-shadow:0 0 0 1px rgba(194,194,200,0.3);}\n' +
    ...
    '.t-email-extractor .ee-btn-secondary{color:rgba(168,168,176,0.8);}\n' +
    '.t-email-extractor .ee-btn-secondary:hover{color:rgba(232,232,234,0.9);}\n' +
    '.t-email-extractor .ee-check-label{display:flex;align-items:center;gap:0.375rem;font-family:var(--font-mono);font-size:12px;color:rgba(168,168,176,0.8);cursor:pointer;}\n' +
    '.t-email-extractor .ee-check-label input{width:16px;height:16px;accent-color:#c2c2c8;cursor:pointer;}\n' +
    '.t-email-extractor .ee-badge{color:rgba(168,168,176,0.8);}\n' +
    '.t-email-extractor .ee-fg90{color:rgba(232,232,234,0.9);}\n' +
    '.t-email-extractor .ee-muted70{color:rgba(168,168,176,0.7);}\n' +
    '.t-email-extractor .ee-out-pre{max-height:16rem;color:rgba(232,232,234,0.9);}\n' +
    '.t-email-extractor .ee-diff-pre{max-height:10rem;color:rgba(232,232,234,0.85);}\n' +
  ...
  mount: function (root) {
    ...
    var lowercaseChk = App.el('input', { type: 'checkbox', style: 'width:16px;height:16px;accent-color:#c2c2c8;cursor:pointer' });
    lowercaseChk.addEventListener('change', function () { lowercase = lowercaseChk.checked; });
    var sortChk = App.el('input', { type: 'checkbox', style: 'width:16px;height:16px;accent-color:#c2c2c8;cursor:pointer' });
